In this project, we will use the same NCDB dataset we used for project in Python/ Jupyter Notebook(another project in same repository)for the following reasons:
<ol>
